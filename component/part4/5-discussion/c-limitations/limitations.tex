...
We do not explore reward weighting, scheduling, or curriculum strategies that might improve the combined run's performance.
...
For example, a response with correct reasoning but a transcription error in the final line would be classified as ``arithmetic error'' or ``wrong setup'' rather than a more nuanced category.
